...
function ExploreNFTs() {
  ...
  return (
    <>
    {
      ...
      (
        <>
          <h1 className="py-10 px-20 text-3xl">No Items in The MarketPlace</h1>
        </>
      )
      : 
      (<>
      <section className="con">
              <h1 className="space-heading margin-heading">NFTs</h1>
              <br />
              <br />
        <div className="nft-cards">
          {
            nfts.map((nft,idx) => (
              <div  key={idx}>
                <NFTCards nft={nft}/>
                <button className="btn" onClick={() => buyNft(nft)}>Buy it!</button>
              </div>
            ))
          } 
        </div>
